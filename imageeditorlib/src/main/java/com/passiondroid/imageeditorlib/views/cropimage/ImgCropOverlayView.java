...
public class ImgCropOverlayView extends View {
  ...
  private ImgCropImageView.Guidelines mGuidelines;

  /** The shape of the cropping area - rectangle/circular. */
  private ImgCropImageView.CropShape mCropShape;
  ...
  public ImgCropOverlayView(Context context) {
    this(context, null);
  }

  public ImgCropOverlayView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
  ...
  /** The shape of the cropping area - rectangle/circular. */
  public ImgCropImageView.CropShape getCropShape() {
    return mCropShape;
  }

  /** The shape of the cropping area - rectangle/circular. */
  public void setCropShape(ImgCropImageView.CropShape cropShape) {
    if (mCropShape != cropShape) {
      mCropShape = cropShape;
        if (Build.VERSION.SDK_INT <= 17) {
        if (mCropShape == ImgCropImageView.CropShape.OVAL) {
  ...
  public ImgCropImageView.Guidelines getGuidelines() {
    return mGuidelines;
  }
   ...
   * application.
   */
  public void setGuidelines(ImgCropImageView.Guidelines guidelines) {
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (mCropWindowHandler.showGuidelines()) {
      ...
      if (mGuidelines == ImgCropImageView.Guidelines.ON) {
        drawGuidelines(canvas);
      } else if (mGuidelines == ImgCropImageView.Guidelines.ON_TOUCH && mMoveHandler != null) {
  ...
  private void drawBackground(Canvas canvas) {
    ...
    if (mCropShape == ImgCropImageView.CropShape.RECTANGLE) {
      ...
      mPath.reset();
        if (Build.VERSION.SDK_INT <= 17 && mCropShape == ImgCropImageView.CropShape.OVAL) {
  ...
  private void drawCorners(Canvas canvas) {
    if (mBorderCornerPaint != null) {
      ...
      float w =
          cornerWidth / 2
              + (mCropShape == ImgCropImageView.CropShape.RECTANGLE ? mBorderCornerOffset : 0);
