...
final class BitmapCroppingWorkerTask
  ...
  private final WeakReference<ImgCropImageView> mCropImageViewReference;
  ...
  private final ImgCropImageView.RequestSizeOptions mReqSizeOptions;
  ...
  BitmapCroppingWorkerTask(
      ImgCropImageView cropImageView,
      Bitmap bitmap,
      float[] cropPoints,
      int degreesRotated,
      ...
      ImgCropImageView.RequestSizeOptions options,
      Uri saveUri,
  ...
  protected void onPostExecute(Result result) {
    if (result != null) {
      ...
      if (!isCancelled()) {
        ImgCropImageView cropImageView = mCropImageViewReference.get();
